...
export const projects = [
  ...
  },
  {
    ...
    features: [
      "Prévisions de stock par IA (scikit-learn, XGBoost, Prophet)",
      "Service Python FastAPI dédié aux modèles ML",
      "Intégration Anthropic AI (Claude) et Google Gemini",
      "Calcul automatique des commandes (méthode EOQ)",
      "Authentification JWT + 2FA + RBAC (4 niveaux de rôles)",
      "Dashboard analytique avec Recharts — revenus, top produits, tendances",
    ],
    stack: ["Next.js", "TypeScript", "Express", "Prisma", "PostgreSQL", "Python", "FastAPI", "scikit-learn", "Redis"],
    live: "https://smartstock-ai-topaz.vercel.app/",
    github: "https://github.com/Mtg221/smartstock-ai",
  ...
  },
  {
    ...
    features: [
      "Création et édition de factures avec génération PDF (Puppeteer)",
      "Gestion des clients et suivi des paiements",
      "Notifications temps réel via WebSockets (Socket.io)",
      "Authentification JWT sécurisée avec CSRF protection",
      "Export CSV et tableaux de bord analytiques",
      "Architecture NestJS modulaire avec Prisma ORM et Redis",
    ],
    stack: ["React", "Vite", "TypeScript", "NestJS", "Prisma", "PostgreSQL", "Redis", "Socket.io", "Docker"],
    live: "https://facturation-rust.vercel.app/",
    github: "https://github.com/Mtg221/facturation",
